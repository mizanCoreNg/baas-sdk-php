<?php
/**
 * DeveloperPortalWebhookDeliveryLogsApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DeveloperPortalWebhookDeliveryLogsApi Class Doc Comment
 *
 * @category Class
 * @package  MizanCore\BaasSdk\Generated
 * @author   OpenAPI Generator team
...
class DeveloperPortalWebhookDeliveryLogsApi
{
    ...
    /**
     * Operation webhookDeliveryLogIndex
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookDeliveryLogIndex'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->webhookDeliveryLogIndexWithHttpInfo($x_tenant_id, $contentType);
        return $response;
    }

    /**
     * Operation webhookDeliveryLogIndexWithHttpInfo
     *
     * List webhook delivery logs
     *
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
    ...
    /**
     * Operation webhookDeliveryLogIndexAsync
     *
     * List webhook delivery logs
     *
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
     ...
     */
    public function webhookDeliveryLogIndexAsync($x_tenant_id, string $contentType = self::contentTypes['webhookDeliveryLogIndex'][0])
    {
        return $this->webhookDeliveryLogIndexAsyncWithHttpInfo($x_tenant_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookDeliveryLogIndexAsyncWithHttpInfo
     *
     * List webhook delivery logs
     *
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
    ...
    /**
     * Create request for operation 'webhookDeliveryLogIndex'
     *
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookDeliveryLogIndex'] to see the possible values for this operation
     *
     ...
     */
    public function webhookDeliveryLogIndexRequest($x_tenant_id, string $contentType = self::contentTypes['webhookDeliveryLogIndex'][0])
    {

        // verify the required parameter 'x_tenant_id' is set
        if ($x_tenant_id === null || (is_array($x_tenant_id) && count($x_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_tenant_id when calling webhookDeliveryLogIndex'
            );
        }
        if (strlen($x_tenant_id) < 1) {
            throw new \InvalidArgumentException('invalid length for "$x_tenant_id" when calling DeveloperPortalWebhookDeliveryLogsApi.webhookDeliveryLogIndex, must be bigger than or equal to 1.');
        }
        if (!preg_match("/^[A-Za-z0-9._-]+$/", $x_tenant_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_tenant_id\" when calling DeveloperPortalWebhookDeliveryLogsApi.webhookDeliveryLogIndex, must conform to the pattern /^[A-Za-z0-9._-]+$/.");
        }
        

        $resourcePath = '/api/v1/developer/webhooks/deliveries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhookDeliveryLogRetry
     *
     * Retry a failed webhook delivery
     *
     * @param  string $id id (required)
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookDeliveryLogRetry'] to see the possible values for this operation
     *
     * @throws \MizanCore\BaasSdk\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->webhookDeliveryLogRetryWithHttpInfo($id, $x_tenant_id, $contentType);
        return $response;
    }

    /**
     * Operation webhookDeliveryLogRetryWithHttpInfo
     *
     * Retry a failed webhook delivery
     *
    ...
    /**
     * Operation webhookDeliveryLogRetryAsync
     *
     * Retry a failed webhook delivery
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookDeliveryLogRetryAsync($id, $x_tenant_id, string $contentType = self::contentTypes['webhookDeliveryLogRetry'][0])
    {
        return $this->webhookDeliveryLogRetryAsyncWithHttpInfo($id, $x_tenant_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookDeliveryLogRetryAsyncWithHttpInfo
     *
     * Retry a failed webhook delivery
     *
     * @param  string $id (required)
    ...
    /**
     * Create request for operation 'webhookDeliveryLogRetry'
     *
     * @param  string $id (required)
     * @param  string $x_tenant_id Tenant identifier (UUID or domain, e.g. world.test.localhost). Required on every tenant-scoped route. Maps to the tenant whose database serves this request. In production, prefer Host-header-based resolution; X-Tenant-ID is intended for non-production environments and is rejected (HTTP 400) on production hosts. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookDeliveryLogRetry'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookDeliveryLogRetryRequest($id, $x_tenant_id, string $contentType = self::contentTypes['webhookDeliveryLogRetry'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhookDeliveryLogRetry'
            );
        }
        ...
        if ($x_tenant_id === null || (is_array($x_tenant_id) && count($x_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_tenant_id when calling webhookDeliveryLogRetry'
            );
        }
        if (strlen($x_tenant_id) < 1) {
            throw new \InvalidArgumentException('invalid length for "$x_tenant_id" when calling DeveloperPortalWebhookDeliveryLogsApi.webhookDeliveryLogRetry, must be bigger than or equal to 1.');
        }
        if (!preg_match("/^[A-Za-z0-9._-]+$/", $x_tenant_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_tenant_id\" when calling DeveloperPortalWebhookDeliveryLogsApi.webhookDeliveryLogRetry, must conform to the pattern /^[A-Za-z0-9._-]+$/.");
        }
        

        $resourcePath = '/api/v1/developer/webhooks/deliveries/{id}/retry';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
