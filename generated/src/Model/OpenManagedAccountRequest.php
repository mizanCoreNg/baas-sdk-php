...
/**
 * OpenManagedAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  MizanCore\BaasSdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
class OpenManagedAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenManagedAccountRequest';
    ...
    */
    ...
    public function setProductId($product_id)
    {
        ...
        if ((mb_strlen($product_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_id when calling OpenManagedAccountRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling OpenManagedAccountRequest., must be smaller than or equal to 255.');
        }
