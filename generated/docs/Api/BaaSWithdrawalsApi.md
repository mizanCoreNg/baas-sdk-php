# MizanCore\BaasSdk\Generated\BaaSWithdrawalsApi

All URIs are relative to https://api.mizancore.ng, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**baasWithdrawalIndex()**](BaaSWithdrawalsApi.md#baasWithdrawalIndex) | **GET** /api/v1/baas/withdrawals | List withdrawal transactions |
| [**baasWithdrawalShow()**](BaaSWithdrawalsApi.md#baasWithdrawalShow) | **GET** /api/v1/baas/withdrawals/{id} | Get withdrawal details |
| [**baasWithdrawalStore()**](BaaSWithdrawalsApi.md#baasWithdrawalStore) | **POST** /api/v1/baas/withdrawals | Initiate a withdrawal |
| [**developerWithdrawalsIndex()**](BaaSWithdrawalsApi.md#developerWithdrawalsIndex) | **GET** /api/v1/developer/withdrawals | List withdrawal transactions |
| [**developerWithdrawalsShow()**](BaaSWithdrawalsApi.md#developerWithdrawalsShow) | **GET** /api/v1/developer/withdrawals/{id} | Get withdrawal details |
| [**developerWithdrawalsStore()**](BaaSWithdrawalsApi.md#developerWithdrawalsStore) | **POST** /api/v1/developer/withdrawals | Initiate a withdrawal |
...
try {
    $result = $apiInstance->baasWithdrawalIndex($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWithdrawalsApi->baasWithdrawalIndex: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->baasWithdrawalShow($id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWithdrawalsApi->baasWithdrawalShow: ', $e->getMessage(), PHP_EOL;
}
```
...
$initiate_withdrawal_request = {"amount":50000,"destination_account":"0123456789","destination_bank":"058","narration":"BK01 successful withdrawal"}; // \MizanCore\BaasSdk\Generated\Model\InitiateWithdrawalRequest

try {
    $result = $apiInstance->baasWithdrawalStore($x_tenant_id, $idempotency_key, $initiate_withdrawal_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWithdrawalsApi->baasWithdrawalStore: ', $e->getMessage(), PHP_EOL;
}
```
...
| **initiate_withdrawal_request** | [**\MizanCore\BaasSdk\Generated\Model\InitiateWithdrawalRequest**](../Model/InitiateWithdrawalRequest.md)|  | |
...
try {
    $result = $apiInstance->developerWithdrawalsIndex($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWithdrawalsApi->developerWithdrawalsIndex: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->developerWithdrawalsShow($id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWithdrawalsApi->developerWithdrawalsShow: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BaaSWithdrawalsApi->developerWithdrawalsStore: ', $e->getMessage(), PHP_EOL;
}
```
