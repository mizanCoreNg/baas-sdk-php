...
| [**developerAccountsShow()**](DeveloperPortalManagedAccountsApi.md#developerAccountsShow) | **GET** /api/v1/developer/accounts/{accountId} | Get a managed account |
...
| [**managedAccountShow()**](DeveloperPortalManagedAccountsApi.md#managedAccountShow) | **GET** /api/v1/baas/accounts/{accountId} | Get a managed account |
...
```php
developerAccountsIndex($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
[**\MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response**](../Model/ManagedAccountIndex200Response.md)
...
```php
developerAccountsShow($account_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
try {
    $result = $apiInstance->developerAccountsShow($account_id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DeveloperPortalManagedAccountsApi->developerAccountsShow: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
developerCustomersAccountsIndex($customer_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
```php
developerCustomersAccountsStore($customer_id, $x_tenant_id, $open_managed_account_request): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
```php
managedAccountIndex($customer_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
```php
managedAccountShow($account_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
...
try {
    $result = $apiInstance->managedAccountShow($account_id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DeveloperPortalManagedAccountsApi->managedAccountShow: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
managedAccountStore($customer_id, $x_tenant_id, $idempotency_key, $open_managed_account_request): \MizanCore\BaasSdk\Generated\Model\ManagedAccountIndex200Response
```
