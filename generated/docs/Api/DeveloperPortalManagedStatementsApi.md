# MizanCore\BaasSdk\Generated\DeveloperPortalManagedStatementsApi

All URIs are relative to https://api.mizancore.ng, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**developerAccountsStatement()**](DeveloperPortalManagedStatementsApi.md#developerAccountsStatement) | **GET** /api/v1/developer/accounts/{accountId}/statement | Get a managed customer account statement |
| [**managedCustomerStatementShow()**](DeveloperPortalManagedStatementsApi.md#managedCustomerStatementShow) | **GET** /api/v1/baas/accounts/{accountId}/statement | Get a managed customer account statement |


## `developerAccountsStatement()`

```php
developerAccountsStatement($account_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
$apiInstance = new MizanCore\BaasSdk\Generated\Api\DeveloperPortalManagedStatementsApi(
...
try {
    $result = $apiInstance->developerAccountsStatement($account_id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DeveloperPortalManagedStatementsApi->developerAccountsStatement: ', $e->getMessage(), PHP_EOL;
}
```
...
## `managedCustomerStatementShow()`

```php
managedCustomerStatementShow($account_id, $x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
try {
    $result = $apiInstance->managedCustomerStatementShow($account_id, $x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DeveloperPortalManagedStatementsApi->managedCustomerStatementShow: ', $e->getMessage(), PHP_EOL;
}
```
