...
```php
developerWalletBalance($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\PartnerWalletBalance200Response
```
...
```php
developerWalletTransactions($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\PartnerTransactionIndex200Response
```
...
```php
partnerWalletBalance($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\PartnerWalletBalance200Response
```
...
```php
partnerWalletTransactions($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\PartnerTransactionIndex200Response
```
