# MizanCore\BaasSdk\Generated\BaaSWalletApi

All URIs are relative to https://api.mizancore.ng, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**developerWalletBalance()**](BaaSWalletApi.md#developerWalletBalance) | **GET** /api/v1/developer/wallet/balance | Get wallet balance |
| [**developerWalletTransactions()**](BaaSWalletApi.md#developerWalletTransactions) | **GET** /api/v1/developer/wallet/transactions | List wallet transactions |
| [**partnerWalletBalance()**](BaaSWalletApi.md#partnerWalletBalance) | **GET** /api/v1/baas/wallet/balance | Get wallet balance |
| [**partnerWalletTransactions()**](BaaSWalletApi.md#partnerWalletTransactions) | **GET** /api/v1/baas/wallet/transactions | List wallet transactions |


## `developerWalletBalance()`

```php
developerWalletBalance($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
$apiInstance = new MizanCore\BaasSdk\Generated\Api\BaaSWalletApi(
...
try {
    $result = $apiInstance->developerWalletBalance($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWalletApi->developerWalletBalance: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
developerWalletTransactions($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
try {
    $result = $apiInstance->developerWalletTransactions($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWalletApi->developerWalletTransactions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
partnerWalletBalance($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
try {
    $result = $apiInstance->partnerWalletBalance($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWalletApi->partnerWalletBalance: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
partnerWalletTransactions($x_tenant_id): \MizanCore\BaasSdk\Generated\Model\VirtualAccountQueryIndex200Response
```
...
try {
    $result = $apiInstance->partnerWalletTransactions($x_tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BaaSWalletApi->partnerWalletTransactions: ', $e->getMessage(), PHP_EOL;
}
```
